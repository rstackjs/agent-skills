...
4. Validate environment/globals/include-exclude behavior after config migration.
5. Re-check mock behavior for re-export modules in Rspack projects if failures appear.
