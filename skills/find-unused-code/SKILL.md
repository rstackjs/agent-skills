...
6. Call `dead_code_explain` for the strongest candidate. Add `code_evidence` when compatible test or execution evidence helps prioritize it.
7. Report root exhaustion, state axes, truncation, bounds, provenance, and artifact binding.
