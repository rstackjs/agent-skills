...
description: Use when explaining why one Rstack artifact module is reachable, retained, shipped, or apparently unused.
---
...
5. Lead with the returned classification: reachable, unreachable candidate, or insufficient evidence.
...
Optimizer retention is independent module evidence. A side-effect or optimizer bailout explains a
retention constraint after reachability; it does not create a product root. Report its state and
reasons alongside, rather than instead of, the reachability classification.
